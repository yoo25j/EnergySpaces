...
/**
 * Quat is a Quaternion.  A Quaternion represent an orientation in space.
 * They consist of a vector x,y,z and rotation w about the vector.
 * (The also have other interesting properties).
 * 
...
public class Quat {
	...
	/**
	 * Creates Quaternion based on Euler anges.
	 ...
	 * warning: this method is untested!
	 * based on https://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles
	 * @return a vector with the quaternion's rotation represented as pitch yaw and roll
	 */
