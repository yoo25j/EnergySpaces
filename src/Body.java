...
public class Body 
{
	...
	/**
	 * get track id.  These should remain consistent between frames (where body number in the list may not)
	 * @return
	 */
	public long getId() {
		return id;
	...
	/**
	 * for information see  https://msdn.microsoft.com/en-us/library/dn785526.aspx
	 * x,y is lean.  z is 0
	 * @return lean 
	 */
	public PVector lean() {
